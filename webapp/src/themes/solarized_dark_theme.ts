// `colors.editor.foreground` used to be 839496, which was making the suggestions too dim
...
export default {
    ...
    "colors": {
        // `editor.foreground` used to be 839496, which was making the suggestions too dim
